...
<html lang="tr-TR">
   ...
   <body>
     ...
     <header class="header">
        ...
        <nav class="navbar">
            ...
            <a href="bookings.php" class="active">Randevularım</a>
   ...
   <section class="bookings">
      ...
      <div class="box-container">
         ...
         $select_bookings = $conn->prepare("SELECT * FROM `bookings`WHERE email = '$mycookiename' ");
         ...
         <div class="box" style="text-align: center;">
            ...
            <a href="user_page.php#reservation"  class="adminbtn">Yeni rezervasyon</a>
         </div>
         <?php
         }
         ?>
