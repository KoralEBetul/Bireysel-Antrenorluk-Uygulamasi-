...
<section class="menu" id="menu"> 
        ...
        <div class="box-container">
            <div class="boxgymbaslik" style="text-align: center;">
                <h3 class="title" style="margin-bottom: .5rem;">Yeni Salon Oluştur</h3>
                <a href="add_gym.php" class="btn">Ekle</a>
            </div>
            ...
            <div class="box">
                ...
                <form action="" method="post" class="flex-btn">
                    ...
                    <a href="update_gym.php?get_id=<?= $playlist_id; ?>" class="option-btn">update</a>
...
<!--!
        <div class="box-container">
           ...
           $select_playlist = $conn->prepare("SELECT * FROM `playlist`");
            ...
            ?>
            <div class="box">
                <p>Salon Başlığı: <span><?= $fetch_playlist['title']; ?></span></p>
                <p>Salon Tanımı : <span><?= $fetch_playlist['description']; ?></span></p>
